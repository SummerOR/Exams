...
for line in f:
    ...
    surveyParticipants.append(courseIndex)
...
for line in f:
    ...
    if courseIndex not in surveyParticipants:
...
conflictsPerEvening = {e:0 for e in schedule.keys()}
...
for evening in schedule.keys():
	...
	for i in xrange(n-1):
		...
		for j in xrange(i+1,n):
			...
			conflictsPerEvening[e] += conflictsBetweenTheseTwo

for evening in schedule.keys():
	print evening, ": ", schedule[evening], conflictsPerEvening[evening]
